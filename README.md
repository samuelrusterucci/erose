...
A detailed description of the algorithm is provided in [Rusterucci et al. (2026)]() summarised on my [personal page](file:///Users/samuelvalentin/Downloads/samuelrusterucci-main/erose.html)). For usage examples, please refer to the [example notebook]().
